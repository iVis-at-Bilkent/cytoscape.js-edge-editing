    ...
    var functions = {
        init: function () {
            ...
            */
            ...
            // function to handle anchors
            var handleAnchors = (typeof opts.handleAnchors === 'undefined') ? true : opts.handleAnchors;
            ...
            if (handleAnchors) {
                menuItems = menuItems.concat(anchorMenuItems);
            }
                    ...
                    if (edge !== undefined) {
                        ...
                        if (index != undefined) {
                            ...
                            if (detachedNode.id() !== newNode.id()) {
                                ...
                                if (handleReconnectEdge == false) {
                                    handleReconnectEdge = function () {
